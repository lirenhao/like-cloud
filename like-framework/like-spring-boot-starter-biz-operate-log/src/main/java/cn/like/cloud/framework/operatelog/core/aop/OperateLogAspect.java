package cn.like.cloud.framework.operatelog.core.aop;
...
import cn.like.cloud.framework.operatelog.core.service.OperateLog;
import cn.like.cloud.framework.operatelog.core.service.OperateLogFrameworkService;
import cn.like.cloud.framework.web.core.util.WebFrameworkUtils;
...
import static cn.like.cloud.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.like.cloud.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        cn.like.cloud.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                cn.like.cloud.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         cn.like.cloud.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           cn.like.cloud.framework.operatelog.core.annotations.OperateLog operateLog,
