...
import cn.like.cloud.framework.tenant.core.mq.TenantChannelInterceptor;
import cn.like.cloud.framework.tenant.core.mq.TenantFunctionAroundWrapper;
...
public class LikeTenantMQAutoConfiguration {
