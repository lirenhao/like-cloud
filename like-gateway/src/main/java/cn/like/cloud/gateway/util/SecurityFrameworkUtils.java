package cn.like.cloud.gateway.util;

import cn.hutool.core.map.MapUtil;
import cn.like.cloud.framework.common.util.json.JsonUtils;
import cn.like.cloud.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 * <p>
 * copy from like-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 */
