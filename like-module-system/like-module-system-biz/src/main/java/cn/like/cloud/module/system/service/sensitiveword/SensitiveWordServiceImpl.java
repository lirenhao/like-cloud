...
import cn.like.cloud.module.system.convert.sensitiveword.SensitiveWordConvert;
...
import cn.like.cloud.module.system.util.collection.SimpleTrie;
...
import static cn.like.cloud.framework.common.util.collection.CollectionUtils.filterList;
import static cn.like.cloud.framework.common.util.collection.CollectionUtils.getMaxValue;
import static cn.like.cloud.module.system.enums.ErrorCodeConstants.SENSITIVE_WORD_EXISTS;
