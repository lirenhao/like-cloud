...
import static cn.like.cloud.framework.common.util.date.DateUtils.isToday;
...
public class SmsCodeServiceImpl implements SmsCodeService {
    ...
    private String createSmsCode(String mobile, Integer scene, String ip) {
        ...
        // 创建验证码记录
        String code = String.valueOf(RandomUtil.randomInt(smsCodeProperties.getBeginCode(), smsCodeProperties.getEndCode() + 1));
