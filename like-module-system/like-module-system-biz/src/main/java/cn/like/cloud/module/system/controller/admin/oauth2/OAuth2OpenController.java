...
import cn.like.cloud.framework.common.util.http.HttpUtils;
import cn.like.cloud.framework.common.util.json.JsonUtils;
import cn.like.cloud.framework.operatelog.core.annotations.OperateLog;
...
import cn.like.cloud.module.system.convert.oauth2.OAuth2OpenConvert;
...
import cn.like.cloud.module.system.util.oauth2.OAuth2Utils;
...
import static cn.like.cloud.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.like.cloud.framework.common.exception.util.ServiceExceptionUtil.exception0;
import static cn.like.cloud.framework.common.pojo.CommonResult.success;
import static cn.like.cloud.framework.common.util.collection.CollectionUtils.convertList;
