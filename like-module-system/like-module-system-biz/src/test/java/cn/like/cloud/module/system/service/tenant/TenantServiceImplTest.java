package cn.like.cloud.module.system.service.tenant;

import cn.like.cloud.framework.common.enums.CommonStatusEnum;
import cn.like.cloud.framework.common.pojo.PageResult;
import cn.like.cloud.framework.tenant.config.TenantProperties;
import cn.like.cloud.framework.tenant.core.context.TenantContextHolder;
import cn.like.cloud.framework.test.core.ut.BaseDbUnitTest;
import cn.like.cloud.module.system.controller.admin.tenant.vo.tenant.TenantCreateReqVO;
import cn.like.cloud.module.system.controller.admin.tenant.vo.tenant.TenantExportReqVO;
import cn.like.cloud.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.like.cloud.module.system.controller.admin.tenant.vo.tenant.TenantUpdateReqVO;
import cn.like.cloud.module.system.dal.dataobject.permission.MenuDO;
import cn.like.cloud.module.system.dal.dataobject.permission.RoleDO;
import cn.like.cloud.module.system.dal.dataobject.tenant.TenantDO;
import cn.like.cloud.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.like.cloud.module.system.dal.mysql.tenant.TenantMapper;
import cn.like.cloud.module.system.enums.permission.RoleCodeEnum;
import cn.like.cloud.module.system.enums.permission.RoleTypeEnum;
import cn.like.cloud.module.system.service.permission.MenuService;
import cn.like.cloud.module.system.service.permission.PermissionService;
import cn.like.cloud.module.system.service.permission.RoleService;
import cn.like.cloud.module.system.service.tenant.handler.TenantInfoHandler;
import cn.like.cloud.module.system.service.tenant.handler.TenantMenuHandler;
...
import static cn.like.cloud.framework.common.util.collection.SetUtils.asSet;
import static cn.like.cloud.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
...
import static cn.like.cloud.framework.test.core.util.RandomUtils.*;
import static cn.like.cloud.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static cn.like.cloud.module.system.enums.ErrorCodeConstants.*;
