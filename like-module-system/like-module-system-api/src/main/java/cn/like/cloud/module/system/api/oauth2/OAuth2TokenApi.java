package cn.like.cloud.module.system.api.oauth2;
...
import cn.like.cloud.module.system.enums.ApiConstants;
...
public interface OAuth2TokenApi {
    ...
    @Parameter(name = "accessToken", description = "访问令牌", required = true, example = "token")
    ...
    @Parameters({
            @Parameter(name = "refreshToken", description = "刷新令牌", required = true, example = "refresh"),
