...
* 演示地址【Vue3 + element-plus】：<http://dashboard-vue3.like.iocoder.cn>
* 演示地址【Vue3 + vben(ant-design-vue)】：<http://dashboard-vben.like.iocoder.cn>
* 演示地址【Vue2 + element-ui】：<http://dashboard.like.iocoder.cn>
...
![架构图](https://static.iocoder.cn/like-cloud-architecture.png?imageView2/2/format/webp)

* 管理后台的电脑端：Vue3 提供 [element-plus](https://gitee.com/likecode/like-ui-admin-vue3)、[vben(ant-design-vue)](https://gitee.com/likecode/like-ui-admin-vben) 两个版本，Vue2 提供 [element-ui](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/like-ui-admin) 版本
...
![架构演进](https://static.iocoder.cn/like-roadmap.png?imageView2/2/format/webp)
...
| [like-cloud](https://gitee.com/zhijiantianya/like-cloud)      | [![Gitee star](https://gitee.com/zhijiantianya/like-cloud/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/like-cloud) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/like-cloud.svg?style=social&label=Stars)](https://github.com/YunaiV/like-cloud)               | 基于 Spring Cloud 微服务架构       |
| [Spring-Boot-Labs](https://gitee.com/likecode/SpringBoot-Labs) | [![Gitee star](https://gitee.com/likecode/SpringBoot-Labs/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/like-cloud) [![GitHub stars](https://img.shields.io/github/stars/likecode/SpringBoot-Labs.svg?style=social&label=Stars)](https://github.com/likecode/SpringBoot-Labs) | 系统学习 Spring Boot & Cloud 专栏 |

### 前端项目

| 项目                                                                                                       | Star                                                                                                                                                                                                                                                                                                                                                           | 简介                              |
|----------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|
| [like-ui-admin-vue3](https://gitee.com/likecode/like-ui-admin-vue3)                                   | [![Gitee star](https://gitee.com/likecode/like-ui-admin-vue3/badge/star.svg?theme=white)](https://gitee.com/likecode/like-ui-admin-vue3) [![GitHub stars](https://img.shields.io/github/stars/likecode/like-ui-admin-vue3.svg?style=social&label=Stars)](https://github.com/likecode/like-ui-admin-vue3)                                               | 基于 Vue3 + element-plus 实现的管理后台  |
| [like-ui-admin-vben](https://gitee.com/likecode/like-ui-admin-vben)                                   | [![Gitee star](https://gitee.com/likecode/like-ui-admin-vben/badge/star.svg?theme=white)](https://gitee.com/likecode/like-ui-admin-vben) [![GitHub stars](https://img.shields.io/github/stars/likecode/like-ui-admin-vben.svg?style=social&label=Stars)](https://github.com/likecode/like-ui-admin-vben)                                               | 基于 Vue3 + vben(ant-design-vue) 实现的管理后台 |
| [like-ui-admin](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/like-ui-admin)               | [![Gitee star](https://gitee.com/zhijiantianya/ruoyi-vue-pro/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/like-ui-admin) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/ruoyi-vue-pro.svg?style=social&label=Stars)](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/like-ui-admin)               | 基于 Vue2 + element-ui 实现的管理后台    |
| [like-ui-admin-uniapp](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/like-ui-admin-uniapp) | [![Gitee star](https://gitee.com/zhijiantianya/ruoyi-vue-pro/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/like-ui-admin-uniapp) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/ruoyi-vue-pro.svg?style=social&label=Stars)](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/like-ui-admin-uniapp) | 基于 uni-app + uni-ui 实现的管理后台的小程序 |
| [like-ui-go-view](https://gitee.com/likecode/like-ui-go-view)                                         | [![Gitee star](https://gitee.com/likecode/like-ui-go-view/badge/star.svg?theme=white)](https://gitee.com/likecode/like-ui-go-view) [![GitHub stars](https://img.shields.io/github/stars/likecode/like-ui-go-view.svg?style=social&label=Stars)](https://github.com/likecode/like-ui-go-view)                                                           | 基于 Vue3 + naive-ui 实现的大屏报表      |
| [like-ui-app](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/like-ui-app)                   | [![Gitee star](https://gitee.com/zhijiantianya/ruoyi-vue-pro/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/like-ui-app) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/ruoyi-vue-pro.svg?style=social&label=Stars)](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/like-ui-app)                   | 基于 uni-app + uview 实现的用户 App    |
...
| 🚀  | 系统接口     | 基于 Swagger 自动生成相关的 RestFull API 接口文档          |
| 🚀  | 数据库文档    | 基于 Screw 自动生成数据库文档，支持导出 Word、HTML、MD 格式      |
|     | 表单构建     | 拖动表单元素生成相应的 HTML 代码，支持导出 JSON、Vue 文件         |
| 🚀  | 配置管理     | 对系统动态配置常用参数，支持 SpringBoot 加载                 |
| ⭐️  | 定时任务     | 在线（添加、修改、删除)任务调度包含执行结果日志                     |
| 🚀  | 文件服务     | 支持将文件存储到 S3（MinIO、阿里云、腾讯云、七牛云）、本地、FTP、数据库等   | 
| 🚀  | API 日志   | 包括 RestFull API 访问日志、异常日志两部分，方便排查 API 相关的问题   |
...
| 项目                                                                       | 说明                 |
|--------------------------------------------------------------------------|--------------------|
| `like-dependencies`                                                     | Maven 依赖版本管理       |
| `like-framework`                                                        | Java 框架拓展          |
| `like-server`                                                           | 管理后台 + 用户 APP 的服务端 |
| `like-module-system`                                                    | 系统功能的 Module 模块    |
| `like-module-member`                                                    | 会员中心的 Module 模块    |
| `like-module-infra`                                                     | 基础设施的 Module 模块    |
| `like-module-bpm`                                                       | 工作流程的 Module 模块    |
| `like-module-pay`                                                       | 支付系统的 Module 模块    |
| `like-module-mall`                                                      | 商城系统的 Module 模块    |
| `like-module-mp`                                                        | 微信公众号的 Module 模块   |
| `like-module-report`                                                    | 大屏报表 Module 模块     |
...
| [Nacos](https://github.com/alibaba/nacos)                                                   | 配置中心 & 注册中心      | 2.0.4       | [文档](https://www.iocoder.cn/categories/Nacos/?like)                |
| [RocketMQ](https://github.com/apache/rocketmq)                                              | 消息队列             | 4.9.4       | [文档](https://www.iocoder.cn/categories/RocketMQ/?like)             |
| [Sentinel](https://github.com/alibaba/sentinel)                                             | 服务保障             | 1.8.6       | [文档](https://www.iocoder.cn/categories/Sentinel/?like)             |
| [XXL Job](https://github.com/xuxueli/xxl-job)                                               | 定时任务             | 2.3.1       | [文档](https://www.iocoder.cn/XXL-JOB/good-collection/?like)         |
| [Spring Cloud Gateway](https://github.com/spring-cloud/spring-cloud-gateway)                | 服务网关             | 3.4.1       | [文档](https://www.iocoder.cn/categories/Spring-Cloud-Gateway/?like) |
| [Seata](https://github.com/seata/seata)                                                     | 分布式事务            | 1.6.1       | [文档](https://www.iocoder.cn/categories/Seata/?like)                |
| [MySQL](https://www.mysql.com/cn/)                                                          | 数据库服务器           | 5.7 / 8.0+  |                                                                     |
| [Druid](https://github.com/alibaba/druid)                                                   | JDBC 连接池、监控组件    | 1.2.16      | [文档](http://www.iocoder.cn/Spring-Boot/datasource-pool/?like)      |
| [MyBatis Plus](https://mp.baomidou.com/)                                                    | MyBatis 增强工具包    | 3.5.3.1     | [文档](http://www.iocoder.cn/Spring-Boot/MyBatis/?like)              |
| [Dynamic Datasource](https://dynamic-datasource.com/)                                       | 动态数据源            | 3.6.0       | [文档](http://www.iocoder.cn/Spring-Boot/datasource-pool/?like)      |
| [Redis](https://redis.io/)                                                                  | key-value 数据库    | 5.0 / 6.0   |                                                                     |
| [Redisson](https://github.com/redisson/redisson)                                            | Redis 客户端        | 3.18.0      | [文档](http://www.iocoder.cn/Spring-Boot/Redis/?like)                |
| [Spring MVC](https://github.com/spring-projects/spring-framework/tree/master/spring-webmvc) | MVC 框架           | 5.3.24      | [文档](http://www.iocoder.cn/SpringMVC/MVC/?like)                    |
| [Spring Security](https://github.com/spring-projects/spring-security)                       | Spring 安全框架      | 5.7.5       | [文档](http://www.iocoder.cn/Spring-Boot/Spring-Security/?like)      |
| [Hibernate Validator](https://github.com/hibernate/hibernate-validator)                     | 参数校验组件           | 6.2.5       | [文档](http://www.iocoder.cn/Spring-Boot/Validation/?like)           |
| [Flowable](https://github.com/flowable/flowable-engine)                                     | 工作流引擎            | 6.7.2       | [文档](https://doc.iocoder.cn/bpm/)                                   |
| [Knife4j](https://gitee.com/xiaoym/knife4j)                                                 | Swagger 增强 UI 实现 | 4.0.0       | [文档](http://www.iocoder.cn/Spring-Boot/Swagger/?like)              |
| [SkyWalking](https://skywalking.apache.org/)                                                | 分布式应用追踪系统        | 8.12.0      | [文档](http://www.iocoder.cn/Spring-Boot/SkyWalking/?like)           |
| [Spring Boot Admin](https://github.com/codecentric/spring-boot-admin)                       | Spring Boot 监控平台 | 2.7.10      | [文档](http://www.iocoder.cn/Spring-Boot/Admin/?like)                |
| [Jackson](https://github.com/FasterXML/jackson)                                             | JSON 工具库         | 2.13.3      |                                                                     |
| [MapStruct](https://mapstruct.org/)                                                         | Java Bean 转换     | 1.5.5.Final | [文档](http://www.iocoder.cn/Spring-Boot/MapStruct/?like)            |
| [Lombok](https://projectlombok.org/)                                                        | 消除冗长的 Java 代码    | 1.18.26     | [文档](http://www.iocoder.cn/Spring-Boot/Lombok/?like)               |
