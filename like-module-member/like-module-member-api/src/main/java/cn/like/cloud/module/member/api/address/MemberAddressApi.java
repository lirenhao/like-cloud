...
import cn.like.cloud.module.member.api.address.fallback.MemberAddressApiFallback;
...
@FeignClient(name = ApiConstants.NAME, fallbackFactory = MemberAddressApiFallback.class)
