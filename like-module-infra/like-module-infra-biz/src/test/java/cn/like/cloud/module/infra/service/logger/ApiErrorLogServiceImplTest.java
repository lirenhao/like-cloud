...
import cn.like.cloud.module.infra.api.logger.dto.ApiErrorLogCreateReqDTO;
import cn.like.cloud.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogExportReqVO;
import cn.like.cloud.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.like.cloud.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.like.cloud.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.like.cloud.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.like.cloud.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.like.cloud.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogList() {
        ...
        reqVO.setUserId(2233L);
        reqVO.setUserType(UserTypeEnum.ADMIN.getValue());
        reqVO.setApplicationName("like-test");
        reqVO.setRequestUrl("foo");
        reqVO.setExceptionTime(buildBetweenTime(2021, 3, 1, 2021, 3, 31));
        reqVO.setProcessStatus(ApiErrorLogProcessStatusEnum.INIT.getStatus());
