...
import cn.like.cloud.framework.test.core.util.AssertUtils;
import cn.like.cloud.module.infra.controller.admin.file.vo.file.FilePageReqVO;
import cn.like.cloud.module.infra.dal.dataobject.file.FileDO;
import cn.like.cloud.module.infra.dal.mysql.file.FileMapper;
...
import static cn.like.cloud.module.infra.enums.ErrorCodeConstants.FILE_NOT_EXISTS;
...
public class FileServiceImplTest extends BaseDbUnitTest {
    ...
    public void testDeleteFile_success() throws Exception {
        // mock 数据
        FileDO dbFile = randomPojo(FileDO.class, o -> o.setConfigId(10L).setPath("test.jpg"));
        ...
        // 校验调用
        verify(client).delete(eq("test.jpg"));
    }
    ...
    public void testGetFileContent() throws Exception {
        ...
        when(client.getContent(eq("test.jpg"))).thenReturn(content);
