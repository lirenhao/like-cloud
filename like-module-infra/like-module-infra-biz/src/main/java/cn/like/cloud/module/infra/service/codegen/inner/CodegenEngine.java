package cn.like.cloud.module.infra.service.codegen.inner;
...
import cn.like.cloud.framework.common.exception.util.ServiceExceptionUtil;
...
import cn.like.cloud.framework.common.util.date.LocalDateTimeUtils;
import cn.like.cloud.framework.common.util.object.ObjectUtils;
import cn.like.cloud.framework.excel.core.annotations.DictFormat;
import cn.like.cloud.framework.excel.core.convert.DictConvert;
import cn.like.cloud.framework.excel.core.util.ExcelUtils;
...
import cn.like.cloud.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import cn.like.cloud.module.infra.dal.dataobject.codegen.CodegenTableDO;
import cn.like.cloud.module.infra.enums.codegen.CodegenFrontTypeEnum;
import cn.like.cloud.module.infra.enums.codegen.CodegenSceneEnum;
import cn.like.cloud.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "like-module-${table.moduleName}/" + // 顶级模块
                "like-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "like-module-${table.moduleName}/" + // 顶级模块
                "like-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "like-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "like-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
